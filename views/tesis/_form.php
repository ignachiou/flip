...
<div class="tesis-form">
    ...
    <?= $form->field($model, 'titulo_tesis')->textInput(['maxlength' => true]) ?>

    <?= $form->field($model, 'tutor_tesis')->textInput(['maxlength' => true]) ?>

    <?= $form->field($model, 'cotutor_tesis')->textInput(['maxlength' => true]) ?>

    <?= $form->field($model, 'redactor_tesis')->textInput(['maxlength' => true]) ?>

    <?= $form->field($model, 'fecha_tesis')->textInput(['maxlength' => true]) ?>
    
    <?= $form->field($model, 'universidad')->textInput(['maxlength' => true]) ?>

    <?= $form->field($model, 'resumen_tesis')->textInput(['maxlength' => true]) ?>

    <?= $form->field($model, 'desc1_tesis')->textInput(['maxlength' => true]) ?>

    <?= $form->field($model, 'desc2_tesis')->textInput(['maxlength' => true]) ?>

    <?= $form->field($model, 'desc3_tesis')->textInput(['maxlength' => true]) ?>

    <?= $form->field($model, 'desc4_tesis')->textInput(['maxlength' => true]) ?>    
